...
modify pytrends to be used in python 2.7
Hu Wang, Jun 24, 2015
'''
import httplib #http.client #The httplib module has been renamed to http.client in Python 3
import urllib
from urllib2 import build_opener, HTTPCookieProcessor #from urllib import request
from urllib import urlencode #from urllib import parse
import re
import logging
import cookielib #http.cookiejar #The cookielib module has been renamed to http.cookiejar in Python 3
...
class pyGTrends(object):
    ...
    def _connect(self):
        ...
        resp = re.sub(r'\s\s+', ' ', resp.decode('utf8'))  # python < 3, need to specify utf8 here
    ...
    def request_report(self, keywords, hl='en-US', cat=None, geo=None,
        ...
        combined_params = combined_params.replace(' ', '%20')
